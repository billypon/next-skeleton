/* eslint-disable @typescript-eslint/no-explicit-any, @typescript-eslint/no-unused-vars, @typescript-eslint/no-empty-function, react/sort-comp */
...
export default class ModalX<T = any> {
  ...
  constructor(public props: ModalProps & { content: ReactNode | Template }) {
